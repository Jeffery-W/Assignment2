...
x = [line['lon'] for line in full_train if line['lon'] != 0.0 and line['year'] == 2009]
y = [line['lat'] for line in full_train if line['lat'] != 0.0 and line['year'] == 2009]
assert len(x) == len(y)
print "Done."
...
color_sequence = [colors[line['type']] for line in full_train if line['lon'] != 0.0 and line['year'] == 2009]
